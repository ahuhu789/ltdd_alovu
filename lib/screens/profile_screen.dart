...
class ProfileScreen extends StatelessWidget {
  ...
  ImageProvider? _getAvatarImage(String? avatarLocalPath) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final avatarImage = _getAvatarImage(avatarLocalPath);
                  ...
                  onTap: () async {
                    ...
                    if (context.mounted) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'Nạp thành công! Hãy quay lại trang chủ để kiểm tra nhé.',
                          ),
